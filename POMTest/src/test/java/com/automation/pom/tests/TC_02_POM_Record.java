...
public class TC_02_POM_Record extends baseClass{

@Test(dataProvider = "getTestData")
public void recordDetails(String fna, String lna, String gen,String date, String month, String year, String city) throws Exception {
	...
	rp.regPage(fna, lna, gen, date, month, year, city);
...
Object[][]	data= {
					{"ABC","DEF","Male","10","March","2020","Guntur"}
				   };
